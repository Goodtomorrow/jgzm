...
class Product_detailsController extends Controller
{
    ...
    */
    ...
    public function postInsert(Request $request)
    {
        ...
        $this -> validate($request,[
                ...
                'image.required' => '亲,请添加填写产品图片',
                'name.required' => '亲,请填写产品名称',
                'content.required' => '亲,请填写产品内容',
        ]); 
        ...
        {   
            ...
            {   
                ...
                // 将文件移动到指定的文件夹中  
                $request -> file($k) -> move('./admin/images/uploads/kindeditor/shop/image/product',$image);
            }
        }
        ...
        {   
            ...
            return redirect('/admin/product/index') -> with('success','添加成功');
        }else{
    ...
    public function getIndex(Request $request)
    {
        ...
        {
            // 如果为空，查询并且分页
            $data = DB::table('product')->select() -> paginate($count);
        }else
        {  
            // 如果不为空,按照搜索的关键字查询分页
            $data = DB::table('product')->where('title','like','%'.$search.'%')->select()->paginate($count);
        }
    ...
    */
    ...
    {   
        ...
        {   
            ...
            return redirect('/admin/product/index') -> with('success','删除成功');
        }else{
    ...
    */
    public function getEdit($id)
    {
        ...
        // 解析模板，并且分配数据
        return view('admin/product/edit',['res'=>$res,'arr'=>$arr,'id'=>$id]);
    }
    ...
    */
    public function postUpdate(Request $request){
        ...
        // 利用id查询出来一条信息
        $xx = DB::table('product')->where('id',$arr['id'])->update($arr);

        // 判断修改是否成功
        if($xx){

            // 修改成功
            return redirect('/admin/product/index')->with('success','修改成功');
        }else{
            // 修改不成功
