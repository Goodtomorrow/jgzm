...
class bannerController extends Controller
{
    ...
    public function postInsert(Request $request)
    {
        ...
        $this -> validate($request,[
                ...
                'title.required' => '请填写轮播图标题',
                'image.required' => '请填写轮播图图片',
        ]); 
        ...
        {   
            ...
            {   
                ...
                // 将文件移动到指定的文件夹中  
                $request -> file($k) -> move('./admin/images/uploads//kindeditor/shop/image/banner',$image);
            }
        }
    ...
    */
    public function getIndex(Request $request)
    {
        ...
        {
            // 如果为空，查询并且分页
            $data = DB::table('banner') -> select() -> paginate($count);
        }else
        {  
            // 如果不为空,按照搜索的关键字查询分页
            $data = DB::table('banner') -> where('title','like','%'.$search.'%') -> select() -> paginate($count);
        }
    ...
    */
    public function getDelete($id){
        ...
        // 删除所选的数据
        $xw = DB::table('banner')->where('id',$id)->delete();
    ...
    */
    public function getEdit($id){
        ...
        // 返回视图并分配数据
        return view('/admin/banner/edit',['data'=>$data,'id'=>$id]);
    }
