    ...
    <div class="mws-panel-body no-padding">
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            <div id="DataTables_Table_1_length" class="dataTables_length">
                <form action="/admin/case_cate/index" method="get">
                <label>显示 
                ...
                <tbody>
                    ...
                    <tr style="text-align:center">
                        ...
                        <td>
                            ...
                            ?>
                            {{ str_repeat('|---',$l).$v['cname'] }}
                        </td>
                        <td>{{$v['fid']}}</td>
                        <td>{{$v['path']}}</td>
                        <td>{{$v['time']}}</td>
                        <td>
                            <a href="/admin/case_cate/delete/{{$v['id']}}" style="color:black;font-size:20px;margin-left:10px;" title="删除"><i class="icol-bin-closed"></i></a>
                            <a href="/admin/case_cate/edit/{{$v['id']}}" style="color:black;font-size:20px;margin-left:10px;" title="修改"><i class="icon-pencil" ></i></a>
                            <a href="/admin/case_cate/add/{{$v['id']}}" style="color:black;font-size:20px;margin-left:10px;" title="添加"><i class="icon-plus"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
