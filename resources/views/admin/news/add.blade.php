...
@section('content')   
    ...
    <div class="mws-panel">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/news/insert" method="post" enctype="multipart/form-data" id="form">
            {{ csrf_field() }}
                <div class="mws-form-inline">

                    <div class="mws-form-row">
                        <label class="mws-form-label" style="position:relative;left:60px"><b>新闻名称</b></label>
                    ...
                    <div class="mws-form-row">
                        <label class="mws-form-label" style="position:relative;left:60px"><b>新闻内容</b></label>
                        <div class="mws-form-item">
                   ...
                   <div class="mws-form-row">
                        <label class="mws-form-label" style="position:relative;left:60px"><b>新闻分类</b></label>
                        <div class="mws-form-item">
                            <select name="nid" style="width:700px">
