...
<div class="mws-panel grid_8">
    <div class="mws-panel-header">
        <span><i class="icon-table"></i>荣誉资质列表</span>
    </div>
    <div class="mws-panel-body no-padding">
        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
            <div id="DataTables_Table_1_length" class="dataTables_length">
                <form action="/admin/rongyu/index" method="get">
                <label>显示 
        ...
        <table class="mws-table">
            ...
            <tbody>
                ...
                <tr style="text-align:center">
                    <td>{{ $v['id'] }}</td>
                    <td><img src="/admin/images/uploads/kindeditor/shop/image/rongyu/{{ $v['image'] }}" style="width:50px"/></td>
                    <td>{{ $v['time'] }}</td>
                    <td>
                        <a href="/admin/rongyu/delete/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:10px;" title="删除"><i class="icol-bin-closed"></i></a>
                        <a href="/admin/rongyu/edit/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:10px;" title="修改"><i class="icon-pencil" ></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
