...
@section('content')
	...
	<div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
            ...
            <form class="mws-form" action="/admin/news_cate/insert" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input class="small" type="text" name="name" value=""  style="width:400px">
                        </div>
                    </div>
