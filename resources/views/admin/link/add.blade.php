	...
	@endif
   	...
   	<div class="mws-panel">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/link/insert" method="post" enctype="multipart/form-data" id="form">
            {{ csrf_field() }}
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        <label class="mws-form-label" style="text-align: center" style="postion:relative;left:30px;"><b>友情链接地址</b></label>
                        <div class="mws-form-item">
                            <input class="small" type="text" name="lianjie" value="{{ old('lianjie') }}"  style="width:700px;height:30px;">
                        </div>
                    </div> 
