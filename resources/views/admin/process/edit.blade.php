	...
	@endif
   	...
   	<div class="mws-panel">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/process/update" method="post" enctype="multipart/form-data" id="form">
            {{ csrf_field() }}
                ...
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/process/{{ $data['image'] }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/process/{{ $data['image1'] }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/process/{{ $data['image2'] }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/process/{{ $data['image3'] }}" alt="">
                        </div>
                    </div>   
