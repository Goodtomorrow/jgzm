...
@section('content')   
    ...
    <div class="mws-panel">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/banner/update" method="post" enctype="multipart/form-data" id="form">
            {{ csrf_field() }}
            <input type="hidden" name="id" value="{{ $data['id'] }}">
                <div class="mws-form-inline">

                    <div class="mws-form-row">
                        <label class="mws-form-label" style="position:relative;left:60px"><b>轮播标题</b></label>
                    ...
                    <div class="mws-form-row">
                        <label class="mws-form-label" style="position:relative;left:60px"><b>轮播图片</b></label>
                        <div class="mws-form-item" style="width:700px">
                            <input type="file" name="image" value="{{ $data['image'] }}">
                            <img src="/admin/images/uploads//kindeditor/shop/image/banner/{{ $data['image'] }}" alt="">
                        </div>
                    </div>
