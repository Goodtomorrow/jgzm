        ...
        <table class="mws-table">
            ...
            <tbody>
                ...
                <tr style="text-align:center">
                    <td>{{ $v['id'] }}</td>
                    <td>{{ $v['title'] }}</td>
                    <td><img src="/admin/images/uploads/kindeditor/shop/image/banner/{{ $v['image'] }}" style="width:50px"/></td>
                    <td>{{ $v['time'] }}</td>
                    <td>
                        <a href="/admin/banner/delete/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:10px;" title="删除"><i class="icol-bin-closed"></i></a>
                        <a href="/admin/banner/edit/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:10px;" title="修改"><i class="icon-pencil" ></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
