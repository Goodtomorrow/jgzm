...
<div class="mws-panel grid_8">
    <div class="mws-panel-header">
        <span><i class="icon-table"></i>产品展示列表</span>
    </div>
        ...
        <table class="mws-table">
            ...
            <tbody>
                ...
                <tr style="text-align:center">
                    ...
                    <td>{{ $v['cateid'] }}</td>
                    <td>{{ $v['name'] }}</td>
                    <td> <img src="/admin/images/uploads/kindeditor/shop/image/product/{{ $v['image'] }}" style="width:100px"/></td>
                    <td>{{ $v['time'] }}</td>
                    <td>
                        <a href="/admin/product/delete/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:10px;" title="删除"><i class="icol-bin-closed"></i></a>
                        <a href="/admin/product/edit/{{ $v['id'] }}" style="color:black;font-size:20px;margin-left:10px;" title="修改"><i class="icon-pencil" ></i></a>
                    </td>
                </tr>
                @endforeach
            </tbody>
