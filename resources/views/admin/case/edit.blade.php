	...
	@endif
   	...
   	<div class="mws-panel">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/case/update" method="post" enctype="multipart/form-data" id="form">
            {{ csrf_field() }}
                ...
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:700px;">
                            ...
                            <img src="/admin/images/uploads/kindeditor/shop/image/case/{{ $res['image'] }}" alt="" style="width:700px;">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input class="small" type="text" name="name" value="{{ $res['name'] }}"  style="width:700px;height:30px;" placeholder="请填写案例展示标题">
                        </div>
                    </div>       
                    ...
                    <div class="mws-form-row">
                        <label class="mws-form-label" style="position:relative;left:60px">案例展示分类</label>
                        <div class="mws-form-item">
                            <select name="cid" style="width:700px">
                                <option value="0" selected>----请选择----</option>
                                @foreach($arr as $k=>$v)
                                 <option value="{{ $v['id'] }}" @if($v['id'] == $res['cid']) selected @endif>{{ $v['cname'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
