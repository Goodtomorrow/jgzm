	...
	@endif
   	...
   	<div class="mws-panel">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/industry/update" method="post" enctype="multipart/form-data" id="form">
            {{ csrf_field() }}
                ...
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/industry/{{ $data['image'] }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input class="small" type="text" name="laiyuan" value="{{ $data['laiyuan'] }}" style="width:700px;height:30px;">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/industry/{{ $data['image1'] }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/industry/{{ $data['image2'] }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:400px;">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/industry/{{ $data['image3'] }}" alt="">
                        </div>
                    </div>
