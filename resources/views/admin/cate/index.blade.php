                ...
                <tbody>
                    ...
                    <tr style="text-align:center">
                        ...
                        <td>
                            ...
                            ?>
                            {{ str_repeat('|---',$l).$v['cate_name'] }}
                        </td>
                        <td>{{$v['fid']}}</td>
                        <td>{{$v['path']}}</td>
                        <td>{{$v['cate_time']}}</td>
                        <td>
                            <a href="/admin/cate/delete/{{$v['id']}}" style="color:black;font-size:20px;margin-left:10px;" title="删除"><i class="icol-bin-closed"></i></a>
                            <a href="/admin/cate/edit/{{$v['id']}}" style="color:black;font-size:20px;margin-left:10px;" title="修改"><i class="icon-pencil" ></i></a>
                            <a href="/admin/cate/add/{{$v['id']}}" style="color:black;font-size:20px;margin-left:10px;" title="添加"><i class="icon-plus"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
