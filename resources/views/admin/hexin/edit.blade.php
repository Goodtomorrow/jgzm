...
@section('content')   
    ...
    <div class="mws-panel">
        ...
        <div class="mws-panel-body no-padding">
            <form class="mws-form" action="/admin/hexin/update" method="post" enctype="multipart/form-data" id="form">
            {{ csrf_field() }}
                ...
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <input class="small" type="text" name="name" value="{{ $data['name'] }}"  style="width:700px;height:30px;">
                        </div>
                    </div>       
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                          <textarea id="editor_id" name="content" style="width:700px;height:300px;"><?php echo $data['content']?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item" style="width:700px">
                            ...
                            <img src="/admin/images/uploads//kindeditor/shop/image/hexin/{{ $data['image'] }}" alt="">
                        </div>
                    </div>
