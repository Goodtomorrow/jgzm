		...
		<div class="content">
			<div class="content_left">
				...
				<div class="div2">
					<ul>
						<li>
							<a href="javascript:;" class="color">新闻资讯<i></i></a>
						</li>
						@foreach($cate as $k=>$v)
						<li>
			...
			<div class="content_con">
				...
				<div class="content_right">
					...
					<div class="sx" style="position:relative;top:60px;left:340px">
						{!! $news->render() !!}
					</div>
				...
				<div class="content_right" id="box">
					...
					<!-- <div class="sx" id="fy">
						<ul>
							<li><p class="shang" onclick="getXia()">上一页</p></li>
							<li>|</li>
							<li><p class="xia" onclick="getShang()">下一页</p></li>
						</ul>
					</div> -->
